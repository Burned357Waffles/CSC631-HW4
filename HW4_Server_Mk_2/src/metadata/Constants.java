...
public class Constants {
	...
	final public static short CMSG_FORFEIT = 107;
	final public static short SMSG_FORFEIT = 207;
	final public static short CMSG_TAUNT = 109;
	final public static short SMSG_TAUNT = 209;
