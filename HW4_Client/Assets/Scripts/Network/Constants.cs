public class Constants
{
	...
	public static readonly short CMSG_TAUNT = 109;
	public static readonly short SMSG_TAUNT = 209;
	public static readonly short CMSG_FORFEIT = 107;
	public static readonly short SMSG_FORFEIT = 207;
